...
DZE_DEPLOYABLES_CONFIG = [
    ...
    ["ItemEtool",[0,3,0],5,-1,false,true,false,true,false,["Land_fort_rampart","Fort_StoneWall_EP1","Land_fort_bagfence_round"],[],["ItemEtool"]],
    ...
    ["ItemRuby",[0,5,2],7,0.1,true,true,true,false,true,["AH6X_DZ","UH1Y_DZ"],[],["ItemRuby"]],
    // deploy military housing in front of the player that is permanent but can't be re-packed by anyone
    ["ItemEmerald",[0,8,0],10,-1,false,false,true,true,false,["Barrack2","Land_fortified_nest_small_EP1"],[],["ItemEmerald"]],
    ["ItemCitrine",[0,1,1],5,-1,false,true,true,true,false,["Baseball","Loudspeaker","MetalBucket","Misc_Videoprojektor","Misc_Videoprojektor_platno","Misc_Wall_lamp","Notebook","SatPhone","Radio","SmallTV","Suitcase"],[],["ItemCitrine"]],
    // deploy some housing items from parts piles in front of the player that are permanent but can be re-packed by anyone
    ["PartGeneric",[0,2,0],5,1,true,true,true,true,false,["Desk","FoldChair","FoldTable","SmallTable","Barrel1","Garbage_can"],[],["PartGeneric"]],
    // deploy some housing items from wood piles in front of the player that are permanent but can be re-packed by anyone
    ["PartWoodPile",[0,2,0],5,1,true,true,true,true,false,["Land_Rack_EP1","Land_Table_EP1","Land_Shelf_EP1","WoodChair","Park_bench2","Park_bench1"],[],["PartWoodPile"]],
    ...
    ["CinderBlocks",[0,2,0],5,1,false,true,false,false,true,["Hhedgehog_concrete","Land_CncBlock","Land_CncBlock_Stripes"],[],["CinderBlocks"]],
